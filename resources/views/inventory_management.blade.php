                  ...
                  <div class="card-body">
                     ...
                     <div class="d-flex justify-content-end mt-3">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#movingItemsModal">
                                <button type="button" class="btn btn-primary" style="margin-right: 10px;">Moving Item</button>
                            </a>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#stockCardModal">
                                <button type="button" class="btn btn-primary" style="margin-right: 10px;">Stock Card</button>
                            </a>
                     </div>
                  </div>
               </div>
